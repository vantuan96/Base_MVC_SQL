...
namespace Kztek.Web.Core.Extensions
{
    ...
    public class TableBuilder<TModel> : ITableBuilder<TModel> where TModel : class
    {
        ...
        public MvcHtmlString ToHtmlUpdate(string id, string CssClass, string EditPath, string DeletePath, bool showHeader = true)
        {
        ...
        public MvcHtmlString ToHtmlUpdate_v2(string id, string CssClass, string EditPath, string DeletePath, bool showHeader = true, bool showStt = true, string pamameters = "", string objId = "", bool detail = false, List<string> listbuycontinue = null)
        {
